...
<head>
    ...
    <@template_cmd name="pathToRoot">
        <link href="${pathToRoot}images/logo.png" rel="icon" type="image/svg">
...
<div id="container">
    ...
    <div id="main">
        <@content/>
        <div class="footer"><span class="go-to-top-icon"><a href="#content"
                                                            id="go-to-top-link"></a></span><span>${footerMessage}</span><span
